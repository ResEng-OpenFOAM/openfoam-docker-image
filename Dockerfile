...
RUN  DEBIAN_FRONTEND=noninteractive apt-get install -y sudo jupyter && apt autoclean
RUN  bash -c "useradd -ms /bin/bash of && echo 'of     ALL=(ALL) NOPASSWD:ALL' >> /etc/sudoers"
USER of
WORKDIR /home/of
